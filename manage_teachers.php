...
<body>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="text-center mt-4">Manage all teachers</h2>
            </div>
            <div class="row">
                ...
                <div class="col-12 mt-3">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-12 col-md-2">
                            <span onclick="manageTeachersInfo()" class="edit">Manage</span>&nbsp;
                            <span onclick="manageTeachersInfo()" class="edit"><i class="fa fa-pencil"></i></span>
                        </div>
                    </div>
                </div>
            </div>
